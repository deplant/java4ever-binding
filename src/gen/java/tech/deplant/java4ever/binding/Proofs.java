...
public class Proofs {
    ...
    */
    public record ParamsOfProofBlockData(@NonNull Map<String,Object> block) {}
    ...
    */
    public record ParamsOfProofTransactionData(@NonNull Map<String,Object> transaction) {}
    ...
    */
    public record ParamsOfProofMessageData(@NonNull Map<String,Object> message) {}
    /**
    * <h2>proofs.proof_block_data</h2>
    ...
    */
    ...
    /**
    * <h2>proofs.proof_transaction_data</h2>
    ...
    */
    ...
    /**
    * <h2>proofs.proof_message_data</h2>
