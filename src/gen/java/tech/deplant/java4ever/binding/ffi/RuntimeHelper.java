    ...
    private static class VarargsInvoker {
        ...
        static MethodHandle make(MemorySegment symbol, FunctionDescriptor function) {
            ...
            if (mtype.returnType().equals(MemorySegment.class)) {
                ...
                handle = MethodHandles.insertArguments(handle, 0, RuntimeHelper.THROWING_ALLOCATOR);
            }
        ...
        private Object invoke(SegmentAllocator allocator, Object[] args) throws Throwable {
            ...
            FunctionDescriptor f = (this.function.returnLayout().isEmpty()) ?
                    FunctionDescriptor.ofVoid(argLayouts) :
                    FunctionDescriptor.of(this.function.returnLayout().get(), argLayouts);
            MethodHandle mh = RuntimeHelper.LINKER.downcallHandle(this.symbol, f);
